...
void id() {
  ...
  if (Always && EXIST(balls)) {
    if (DX(balls[0]) * VX(balls[0]) < 0 && (STATE(balls[0]) == 3000 || STATE(balls[0]) >= 3005)) {
      ...
      if ((ABSRANGE(balls[0], 80, 14) && abs(DY(balls[0])) <= 100) || (VZ(balls[0]) != 0 && ABSRANGE(balls[0], 100, 20)))
        D();
      else if ((self.state <= 1 || self.state == 5) && (ABSRANGE(balls[0], 110, 14) && STATE(balls[0]) == 3000))
        A();
  ...
  if (Sometimes) {
    //Super punch.
    if (((EXIST(weapons) && HITABLE(weapons[0], 60)) || STATE(enemies[0]) == 8 || (Hardly && STATE(enemies[0]) == 12) || (self.frame == 110 && self.bdefend > 0)) && HITABLE(enemies[0], 72) && BLINK(enemies[0]) == 0 && !specialmove && !warning)
      DuA();
    //Balls.
    if ((RANGEX(enemies[0], -300, -200) || RANGEX(enemies[0], 200, 300)) && abs(DZ(enemies[0])) > 14 && abs(DZ(enemies[0])) <= 40 && self.state <= 1 && self.mp >= 125 && BLINK(enemies[0]) == 0 && STATE(enemies[0]) != 14 && !specialmove && !warning) {
      if (DX(enemies[0]) < 0)
        DlA();
      else
        DrA();
    ...
    //Cleg.
    if ((RANGEX(enemies[0], -70, -50) || RANGEX(enemies[0], 50, 70)) && abs(DZ(enemies[0])) <= 10 && BLINK(enemies[0]) == 0 && STATE(enemies[0]) != 7 && STATE(enemies[0]) != 12 && STATE(enemies[0]) != 14 && INFRONT(enemies[0]) && self.state <= 1 && self.mp >= 50 && !specialmove && !warning) {
      DdA();
    }
    //Fly crash.
    if ((RANGEX(enemies[0], -120, -50) || RANGEX(enemies[0], 50, 120)) && abs(DZ(enemies[0])) <= 30 && ((DZ(enemies[0]) == 0 || abs(DX(enemies[0])) / abs(DZ(enemies[0])) >= mindashx / mindashz) || abs(DZ(enemies[0])) <= 14) && BLINK(enemies[0]) == 0 && STATE(enemies[0]) >= 2 && STATE(enemies[0]) != 7 && STATE(enemies[0]) != 14 && self.mp >= 200 && !specialmove && !warning) {
      specialmove = true;
      if (DX(enemies[0]) < 0)
        DlJ();
      else
